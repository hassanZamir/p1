...
function init(resources) {
  ...
  cameraAnimation = new Animation(camera, 
            [{matrix: mat4.translate(mat4.create(), mat4.create(), vec3.fromValues(0, 1, -10)), duration: 1}], 
            false);
...
function createSceneGraph(gl, resources) {
  ...
  root.append(new TransformationSGNode(glm.transform({ translate: [200,1000,0], rotateX: 0, scale: 100}), [light]));
...
function updateCameraView(context) {
  vec3.add(cameraCenter, cameraPos, vec3.fromValues(0, 0, 10));
