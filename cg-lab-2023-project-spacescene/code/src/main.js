...
loadResources({
  ...
  spaceship: './src/models/spaceship/E 45 Aircraft_object.obj',
  earth: './src/models/earth/world.obj'
...
function createSceneGraph(gl, resources) {
  ...
  // create spaceship
  let spaceship = new MaterialSGNode([
    new RenderSGNode(resources.spaceship)
  ]);
  //gold
  spaceship.ambient = [0.24725, 0.1995, 0.0745, 1];
  spaceship.diffuse = [0.75164, 0.60648, 0.22648, 1];
  spaceship.specular = [0.628281, 0.555802, 0.366065, 1];
  spaceship.shininess = 50;
  ...
  // create earth
  let earth = new MaterialSGNode([
    new RenderSGNode(resources.earth)
  ]);
  // add earth to scenegraph
